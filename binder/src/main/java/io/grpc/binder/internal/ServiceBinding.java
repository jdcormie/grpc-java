  ...
  public ServiceInfo resolve() throws StatusException {
    ...
    Context targetUserContext =
        targetUserHandle != null
            ? createContextAsUser(sourceContext, targetUserHandle, 0)
            : sourceContext;
    PackageManager packageManager = targetUserContext.getPackageManager();
    int flags = 0;
    ...
    ResolveInfo resolveInfo = packageManager.resolveService(bindIntent, flags);
    if (resolveInfo == null) {
