 ...
 *
 * <p>grpc-java can't call Android methods marked @SystemApi directly. Being a library built outside
 * the Android source tree, these "non-SDK" elements simply don't exist from our compiler's
 * perspective. Instead we resort to reflection but use the static wrappers found here to keep call
 * sites readable and type safe.
 *
