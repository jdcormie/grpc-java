 ...
 * is modeled as an instance of QueryParams containing a single lone key. It must be this way if we
 * are to simultaneously 1) support lone keys, 2) have parse/toRawQuery round-trip transparency, and
 * 3) never fail to parse a valid RFC 3986 query component.
 *
...
public final class QueryParams {
   ...
   *
   * <p>Passing the value returned by {@link io.grpc.Uri#getRawQuery()} is always well-defined and
   * will never fail.
   *
   * <p>Calling {@link #toRawQuery()} on the returned object is guaranteed to return exactly
   * 'rawQuery'.
   *
