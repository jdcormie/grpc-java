...
public final class Uri {
   ...
   * percent-encoded slashes are not segment delimiters but rather part of the first path segment.
   *
   ...
   * slashes are part of the first path segment, not path segment delimiters.
   *
